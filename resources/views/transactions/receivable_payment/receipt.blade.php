...
<head>
    <meta charset="UTF-8">
    <title>NOTA {{ $data['header']->invoice_number }}</title>
...
<body>
    ...
    <table style="width:100%" id="tfoot">
        ...
        <tr>
            ...
            <td align="right" style="font-weight:bold"></td>
            <td align="right" style="font-weight:bold">Sisa</td>
            <td align="right" style="font-weight:bold">
                {{"Rp. " . integers($data['header']->grand_total - $data['paid'])}}
            </td>
        </tr>
    ...
    <div id="footer">
        ...
        <table style="width:100%">
            <tr>
                <td>
                    <p style="font-size:13x;font-style:italic;font-weight:bold">Rek
